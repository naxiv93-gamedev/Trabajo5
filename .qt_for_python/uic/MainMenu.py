...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.botonGenerarInforme = QPushButton(self.centralwidget)
        self.botonGenerarInforme.setObjectName(u"botonGenerarInforme")

        self.gridLayout.addWidget(self.botonGenerarInforme, 0, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"C.A.D.I - Menu Principal", None))
        ...
        self.botonGenerarInforme.setText(QCoreApplication.translate("MainWindow", u"Generar Informe de Alumno", None))
