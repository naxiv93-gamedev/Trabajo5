...
class Ui_DeleteAlumno(object):
    def setupUi(self, DeleteAlumno):
        ...
        self.pushButton = QPushButton(DeleteAlumno)
        self.pushButton.setObjectName(u"pushButton")

        self.horizontalLayout.addWidget(self.pushButton)

        self.pushButton_2 = QPushButton(DeleteAlumno)
    ...
    def retranslateUi(self, DeleteAlumno):
        ...
        self.pushButton.setText(QCoreApplication.translate("DeleteAlumno", u"Cancelar", None))
        self.pushButton_2.setText(QCoreApplication.translate("DeleteAlumno", u"Confirmar", None))
    # retranslateUi
